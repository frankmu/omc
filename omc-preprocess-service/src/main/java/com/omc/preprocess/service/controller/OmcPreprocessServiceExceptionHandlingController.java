package com.omc.preprocess.service.controller;
...
@ControllerAdvice
public class OmcPreprocessServiceExceptionHandlingController {

	private final Log logger = LogFactory.getLog(OmcPreprocessServiceExceptionHandlingController.class);
